...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? HomeWidget() : LoginAccountWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: MyOrderWidget.routeName,
          path: MyOrderWidget.routePath,
        ...
        FFRoute(
          ...
          asyncParams: {
            'driver': getDoc(['user'], UserRecord.fromSnapshot),
          },
        ...
        FFRoute(
          ...
          builder: (context, params) => DeliveryMapWidget(
            deliveryReference: params.getParam(
              'deliveryReference',
        ...
        FFRoute(
          name: StopMapWidget.routeName,
          path: StopMapWidget.routePath,
          builder: (context, params) => StopMapWidget(
            location: params.getParam(
              'location',
              ParamType.LatLng,
            ),
        ...
        FFRoute(
          name: DeltailsDeliveryWidget.routeName,
          path: DeltailsDeliveryWidget.routePath,
          builder: (context, params) => DeltailsDeliveryWidget(
            deliveryReference: params.getParam(
              'deliveryReference',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: DetailsStopWidget.routeName,
          path: DetailsStopWidget.routePath,
          asyncParams: {
            'stopDetails': getDoc(['stop'], StopRecord.fromSnapshot),
          },
          builder: (context, params) => DetailsStopWidget(
            stopDetails: params.getParam(
              'stopDetails',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: DetailsMapWidget.routeName,
          path: DetailsMapWidget.routePath,
          builder: (context, params) => DetailsMapWidget(
            location: params.getParam(
              'location',
              ParamType.LatLng,
            ),
        ...
        FFRoute(
          name: DetailsMapRouteWidget.routeName,
          path: DetailsMapRouteWidget.routePath,
          builder: (context, params) => DetailsMapRouteWidget(
            deliveryReference: params.getParam(
              'deliveryReference',
              ParamType.DocumentReference,
              isList: false,
