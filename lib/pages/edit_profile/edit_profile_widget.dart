...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.emailTextFieldTextController ??= TextEditingController(
        text:
            widget.driver == null ? currentUserEmail : widget.driver?.email);
                                                  ...
                                                  onTap: () async {
                                                    ...
                                                    if (selectedMedia != null &&
                                                      ...
                                                      try {
                                                        ...
                                                        _model.isDataUploading_setData8kt =
                                                            false;
                                                      }
                                                      if (selectedUploadedFiles
                                                          ...
                                                          downloadUrls.length ==
                                                              selectedMedia
                                                                  .length) {
                                                        safeSetState(() {
                                                          _model.uploadedLocalFile_setData8kt =
                                                              selectedUploadedFiles
                                                                  .first;
                                                          _model.uploadedFileUrl_setData8kt =
                                                              downloadUrls
                                                                  .first;
                                                        });
                                                      } else {
                                                      ...
                                                      decoration:
                                                        ...
                                                        hintText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'bw6y46l9' /* Enter your phone number */,
                                                        ),
                                                        hintStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                              ...
                                              Flexible(
                                                child: AuthUserStreamWidget(
                                                  builder: (context) => Text(
                                                    'With us since ${widget.driver == null ? dateTimeFormat(
                                                        "y",
                                                        currentUserDocument
                                                            ?.createdTime,
                                                        locale:
