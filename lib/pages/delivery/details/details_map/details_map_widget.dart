...
import 'details_map_model.dart';
export 'details_map_model.dart';
...
class DetailsMapWidget extends StatefulWidget {
  ...
  static String routeName = 'DetailsMap';
  static String routePath = '/detailsMap';
...
class _DetailsMapWidgetState extends State<DetailsMapWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailsMapModel());
  }
